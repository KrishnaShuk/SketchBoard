...
const features: Feature[] = [
  { icon: Pencil, title: "Hand-Drawn Feel", description: "Create diagrams with a natural, sketchy aesthetic that feels authentic and creative." },
  { icon: Users, title: "Real-Time Collaboration", description: "Work together seamlessly with your team. See changes instantly as others draw." },
  { icon: Zap, title: "Lightning Fast", description: "Built for speed. Start drawing immediately without any lag or delays." },
  { icon: Lock, title: "Privacy First", description: "Your data stays yours. End-to-end encryption keeps your work secure." },
  { icon: Download, title: "Export Anywhere", description: "Export to PNG, SVG, or clipboard. Share your work however you like." },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden pt-20 pb-32">
        <div className="absolute inset-0 bg-gradient-radial from-background to-transparent opacity-60" />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
                Sketch Ideas,<br />Build Together
              </h1>
              
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                A free, open-source digital whiteboard for sketching hand-drawn diagrams. Perfect for brainstorming, teaching, and collaborative design.
              </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Everything you need to <span className="bg-clip-text text-transparent bg-gradient-hero">create freely</span>
              </h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div className="md:col-span-2">
                <h3 className="text-2xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-hero">SketchBoard</h3>
                <p className="text-muted-foreground mb-4">Free and open-source whiteboarding tool for creative minds</p>
